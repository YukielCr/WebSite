...
if(!empty($_GET["id"])){
    ...
    $buscar_imagen=$conexion->query("SELECT ruta_imagen FROM registro_enfermedades WHERE id=$id");
    ...
    $eliminar = $conexion->query("DELETE FROM registro_enfermedades WHERE id=$id");
    if ($eliminar) {
